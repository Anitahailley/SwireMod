...
public class Guineas extends AbstractPower {
    // 能力的ID
    public static final String POWER_ID = CardCreatUtils.getCardId(Guineas.class);
    // 能力的本地化字段
    ...
    public Guineas(AbstractCreature owner, int Amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
